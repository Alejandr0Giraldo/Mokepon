...
function iniciarJuego(){ 
    ...
    sectionVerMapa.style.display = "none"
        ...
        `
        contenedorTarjetas.innerHTML += opcioneDeMoquepones
...
function aleatorio(min, max) {
    return Math.floor(Math.random()*(max - min + 1) +min) //funcion para dar un numero aleatorio
}
